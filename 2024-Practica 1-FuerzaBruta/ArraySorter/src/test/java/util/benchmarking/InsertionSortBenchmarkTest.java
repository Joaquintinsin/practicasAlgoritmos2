...
public class InsertionSortBenchmarkTest {
	...
	/**
	 * Benchmark method. Runs insertion sort and takes measurements described in 
	 * the tags.
  ...
  /**
	...
	public void benchmarkInsertionSort(BenchmarkState state) {
		...
		ArraySorter<Integer> sorter = new ArraySorter<Integer>(state.testArray, SortAlgorithm.SELECTIONSORT);
		sorter.sort();

	}

  /**
	 * Benchmark method. Runs bubble sort and takes measurements described in 
	 * the tags.
	 * Runs multiple times for each size, taking into account warmup runs and iterations.
	 * @param state is the (parameterized) state on which the benchmark method runs.
	 */
	...
	public void benchmarkInsertionSort(BenchmarkState state) {
		...
		ArraySorter<Integer> sorter = new ArraySorter<Integer>(state.testArray, SortAlgorithm.BUBBLESORT);
		sorter.sort();
