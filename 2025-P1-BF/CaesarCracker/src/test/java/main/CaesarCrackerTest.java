...
public class CaesarCrackerTest {
    ...
    public final void testComplexBruteForce() {
        ...
        isDecrypted = cracker.bruteForceDecrypt();
        assertTrue("message decrypted", isDecrypted);
        assertTrue("word found", CaesarCracker.decode(cracker.getEncryptedMessage(), cracker.foundKey())
                .contains(cracker.getMessageWord()));
    }

    /**
     * Tests bruteForceDecrypt on larger decryptable message. Key is correctly
     * found.
     */
    @Test
    ...
    /**
     * Tests bruteForceDecrypt on even larger decryptable message. Key is correctly
     * found.
     */
    @Test
