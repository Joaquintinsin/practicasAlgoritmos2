...
public class SlowSortSmallArraysTest {
   ...
   */
  public SlowSortSmallArraysTest(Object[] params) {
  ...
  public static Collection smallArrays() {
    ...
    return Arrays.asList(new Object[][] {
        ...
        { new Integer[] { 10, 9, 8, 7, 6, 5, 4, 3, 0 } },
        { new Integer[] { 1 } },
        { new Integer[] {} }
    });
  ...
  /**
   * Checks whether slow sort leaves the output array sorted.
   * This is a parameterized unit test. See parameters elsewhere in this class.
   */
  @Test
  public void slowSortLeavesArraySorted() {

    ArraySorter<Integer> sorter = new ArraySorter<Integer>(array, SortAlgorithm.SLOWSORT);
  ...
  /**
   * Checks whether slow sort correctly sorts an array.
   * This test uses differential testing, comparing with the output of
   * util.Arrays.sort(E[]).
   * This is a parameterized unit test. See parameters elsewhere in this class.
   */
  @Test
  public void slowSortSortsCorrectly() {
