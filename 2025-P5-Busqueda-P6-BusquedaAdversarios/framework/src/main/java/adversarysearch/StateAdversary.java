...
public interface StateAdversary extends State {
   ...
   */
  boolean end(); // o gano max o gano min o esta lleno el tablero
   ...
   */
  int value();
  // funcion de valoracion: esta en el estado.
  // entender cual es la idea del juego y como estoy mas lejos o mas cerca de
  // ganar
